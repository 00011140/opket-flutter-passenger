...
class DashboardMapController {
  ...
  Future<void> init() async {
    carIcon = await getScaledMarker('assets/taxi_icon.png', 120, 120);
    await loadMapStyle();
  }
  ...
  void updateUserMarker() async {
    ...
    BitmapDescriptor customMarker = await getScaledMarker(
      'assets/pickup_location.png',
      520,
      500,
    );
